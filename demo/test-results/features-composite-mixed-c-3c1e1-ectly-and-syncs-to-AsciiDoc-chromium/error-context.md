...
- generic [ref=e3]:
  ...
  - generic [active] [ref=e14]:
    - paragraph [ref=e15]: "* *Bold item* one"
    - paragraph [ref=e16]: "* _Italic item_ two"
    - paragraph [ref=e17]: "* `Code item` three"
  - textbox [ref=e18]: "\\* \\*Bold item\\* one \\* \\_Italic item\\_ two \\* \\`Code item\\` three"
```