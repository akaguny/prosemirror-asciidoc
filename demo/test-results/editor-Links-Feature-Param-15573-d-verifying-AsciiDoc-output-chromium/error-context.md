...
- generic [ref=e3]:
  ...
  - generic [active] [ref=e14]:
    - paragraph [ref=e15]: http://example.com/path?param=value&other=test
    - paragraph [ref=e16]: Special Link
    - paragraph [ref=e17]
  - textbox [ref=e18]: http://example.com/path?param=value&other=test Special Link
```