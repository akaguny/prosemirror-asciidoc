...
- generic [ref=e3]:
  ...
  - generic [active] [ref=e14]:
    - paragraph [ref=e15]: First ordered item
    - paragraph [ref=e16]: Second ordered item with nested list
    - paragraph [ref=e17]
    - paragraph [ref=e18]: Nested item 1
    - paragraph [ref=e19]: Nested item 2
  - textbox [ref=e20]: First ordered item Second ordered item with nested list Nested item 1 Nested item 2
```