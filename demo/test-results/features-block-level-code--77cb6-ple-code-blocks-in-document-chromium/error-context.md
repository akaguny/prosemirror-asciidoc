...
- generic [ref=e3]:
  ...
  - generic [active] [ref=e14]:
    - paragraph [ref=e15]: console.log("first");
    - paragraph [ref=e16]
    - paragraph [ref=e17]: Some text
    - paragraph [ref=e18]
    - paragraph [ref=e19]: console.log("second");
  - textbox [ref=e20]: console.log("first"); Some text console.log("second");
```