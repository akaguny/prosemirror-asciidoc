...
- generic [ref=e3]:
  ...
  - generic [active] [ref=e14]:
    - paragraph [ref=e15]: . First *bold* item
    - paragraph [ref=e16]: . Second _italic_ item
    - paragraph [ref=e17]: ". Third `code` item"
  - textbox [ref=e18]: ". First \\*bold\\* item . Second \\_italic\\_ item . Third \\`code\\` item"
```